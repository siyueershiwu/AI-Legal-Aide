...
.dialog-message { margin: 0 0 24px; color: var(--text-secondary); line-height: 1.6; font-size: 0.9rem; }
...
.btn-danger:hover { transform: translateY(-1px); box-shadow: 0 10px 28px rgba(239, 68, 68, 0.4); }
